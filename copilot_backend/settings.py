...
# This tells Django: "Use the Neon Cloud DB. If it's missing, fall back to local SQLite"
DATABASES = {
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://127.0.0.1:5173",
    "https://secureai-copilot-exnr.vercel.app" 
], # <-- Paste your exact frontend link here! (NO slash at the end)
